		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<button class="nav-link py-3 px-0 px-lg-3 rounded" type="submit">Admin</button></form></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="students.jsp">Students</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
