...
<sql:query var="rs" dataSource="${db}">select s.fname,s.lname,su.regno,su.station,su.company,phone from stud_users su join student s using(regno) where su.staff = '${staffno}'</sql:query>
...
<th>Phone Number</th>
 ...
 <td style="width:auto; border: 2px solid black"><c:out value="${row.regno}"></c:out></td>
 <td style="width:auto; border: 2px solid black"><c:out value="${row.station}"></c:out></td>
 <td style="width:auto; border: 2px solid black"><c:out value="${row.company}"></c:out></td>
 <td style="width:auto; border: 2px solid black"><c:out value="${row.phone}"></c:out></td>
 </tr>
 </c:forEach>
	</table>
