			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form onsubmit="return validateRegister()" method="post" action="register" class="register-form"
							id="register-form">
							...
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="id" id="id" placeholder="ID NO" />
							</div> 
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
							...
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="company" id="company" placeholder="Company" />
							</div>
							<div class="form-group">
