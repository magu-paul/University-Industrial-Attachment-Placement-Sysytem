...
<body id="page-top">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#letter" id="button">Update Profile</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href=${letter } download>Download Letter</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
    ...
    <div class="popup">
        <div class="popup-content">
            ...
            <form onsubmit="return upadeValidation()" action="updateStation" method="post">
            <input type="text" placeholder="Reg No" name="regno" id="reg"/>
    ...
    <script>
    function upadeValidation(){
    	var regno = document.getElementById("reg").value.trim();
